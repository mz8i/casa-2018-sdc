    ...
    <b-container fluid id="time-background" type="light">
        <div id="time-container">
            <b-row>
                ...
                <b-col md="3">
                    <p> Each crime type is the result of many different factors. With our grouped data by hour and month,
                    ...
                    Look at different types of crimes to see if this pattern changes! </p>
                </b-col>
            </b-row>
        </div>
    </b-container>
